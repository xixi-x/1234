...
public class MyTest {
    ...
    //改成自己的文件目录
    globalConfig.setAuthor("jia")
            .setOutputDir("D:\\IDEA\\javase_codeExercise\\family_service_platform\\src\\main\\java")//设置输出路径
    ...
    //配置数据源，此处“family_service_platform”为数据库名称，根据自己定义的数据库名称修改
    DataSourceConfig dataSourceConfig = new DataSourceConfig();
    dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/hejia?serverTimezone=UTC")
    ...
    packageConfig.setParent("com.jtt").setMapper("mapper")
